...
const EVALUATOR_GUIDES: Record<string, {
    ...
    'IA-2': {
        ...
        alert: [
            ...
            'No especifica formato de salida ni restricciones (pregunta abierta genérica).',
        ...
        scoring: [
            ...
            { score: 1, desc: 'Prompt vago. Faltan parámetros clave o es demasiado genérico para generar una respuesta precisa.' },
            { score: 0, desc: 'Irrelevante. No tiene relación con el ejercicio o se niega a participar.' },
        ],
    },
}
